...
int main()
{
    ...
    dsh=new dish[numOfFriends*numOfMeals];
    AStack<dish>dirty(dsh,numOfFriends*numOfMeals,1);
    AStack<dish>clean(dsh,numOfFriends*numOfMeals,-1);
     AStack<dish>temp(numOfFriends*numOfMeals);
